...
<div align="center">
  <img src="./Animated%20Ahmed%20Awji%20CLI%20Gif.gif" alt="Ahmed Awji Banner" width="100%" />
  <br />
...
```console
admin@ahmedawji:~$ ls ./tech_stack/
```

<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ts,js,py,html,css,c,cs,java,react,nextjs,vite,vitest,jest,tailwind,materialui,postgres,nodejs,supabase&theme=dark" />
  </a>
</p>

```console
admin@ahmedawji:~$ ./get_status.sh --github
```
...
```console
admin@ahmedawji:~$ ping -c 1 contact.ahmedawji.com
```

```text
PING contact.ahmedawji.com (127.0.0.1) 56(84) bytes of data.
64 bytes from contact.ahmedawji.com (127.0.0.1): icmp_seq=1 ttl=64 time=0.032 ms

--- contact.ahmedawji.com ping statistics ---
1 packets transmitted, 1 received, 0% packet loss, time 0ms
rtt min/avg/max/mdev = 0.032/0.032/0.032/0.000 ms
```

*   📧 **Email:** [ahmedawji@outlook.com](mailto:ahmedawji@outlook.com)
*   🔗 **LinkedIn:** [linkedin.com/in/ahmed-awji](https://linkedin.com/in/ahmed-awji/)
*   🌐 **GitHub:** [@ahmadawji](https://github.com/ahmadawji)
